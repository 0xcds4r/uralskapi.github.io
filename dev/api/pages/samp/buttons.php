<btn class="btn-group button" onClick="redirect('/dev/api/pages/samp/');">SA-MP API</btn> <br />
...
function referExec($value)
{
	...
	$data_script = "<btn class=\"btn-group button\" onClick=\"redirect('/dev/api/pages/samp/?show_page=". $function_name . "');\">" . $function_name . "</btn><br />";
	echo $data_script;
}
